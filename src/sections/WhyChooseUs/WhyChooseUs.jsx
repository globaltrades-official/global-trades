...
const REASONS = [
  ...
  {
    title: 'Imported & Indian Food Products',
    icon: Globe2,
    description:
      'A comprehensive catalogue featuring premier international brands alongside trusted Indian manufacturers.',
  },
  {
    title: 'Store Pickup at Vellayil',
    icon: Store,
    description:
      'Centrally located store at PT Usha Road, Vellayil, welcoming direct purchase and instant stock collection.',
  },
  {
    title: 'Delivery Within Kozhikode',
    icon: Truck,
    description:
      'Reliable, scheduled route deliveries directly to commercial kitchens and cafes throughout Kozhikode.',
  },
  {
    title: 'Quick WhatsApp Ordering',
    icon: WhatsAppIcon,
    description:
      'Fast, hassle-free ordering and instant price confirmations through our dedicated WhatsApp desk (0495 2765320).',
  },
];
      ...
      <div className="mx-auto w-full max-w-7xl px-4 md:px-8 relative z-10">
        ...
        <div className="mx-auto max-w-3xl text-center mb-12 md:mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black uppercase tracking-tight text-[#081426] leading-tight">
            Why Choose Global Trades
          </h2>

          <p className="mt-4 text-base sm:text-lg text-[#081426]/80 font-medium leading-relaxed">
            Genuine wholesale support, transparent trade pricing, and responsive local service for food businesses in Kozhikode.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {REASONS.map((reason, index) => {
            ...
            return (
              <div
                key={reason.title}
                className={`group rounded-3xl bg-[#F4F8FC] p-6 border border-[#D0DFEF] hover:border-[#1A4C98]/40 hover:bg-white hover:shadow-lg transition-all duration-300 flex flex-col justify-between ${
              ...
              >
                ...
                <div className="mt-5 pt-3 border-t border-[#D0DFEF]/60">
                  <span className="text-[11px] font-extrabold text-[#1A4C98] uppercase tracking-wider flex items-center gap-1">
                    ...
                    <span>Verified Wholesale Strength</span>
                  </span>
                </div>
              </div>
            );
        ...
        <div className="mt-12 rounded-2xl bg-gradient-to-r from-[#1A4C98]/5 via-[#00A3E0]/10 to-emerald-500/10 border border-[#1A4C98]/15 p-5 sm:p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="text-center sm:text-left">
            <p className="text-sm font-black text-[#081426]">
              Store Pickup &amp; Kozhikode Delivery Available
            </p>
            <p className="text-xs text-[#081426]/70 mt-0.5">
              PT Usha Road, Vellayil, Kozhikode · Direct walk-ins welcome Mon–Sat 10:00 AM–6:00 PM.
            </p>
          </div>
