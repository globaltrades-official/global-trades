      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center px-4 md:px-8 relative z-10">
        ...
        <div className="grid min-h-[calc(100vh-7rem)] place-items-center py-6 md:py-10 w-full">
          <div className="grid auto-rows-min place-items-center text-center max-w-5xl w-full px-2 sm:px-4">
            ...
            <div className="hero-trust-strip mt-6 sm:mt-8 grid grid-cols-2 sm:flex sm:flex-wrap items-center justify-center gap-2 sm:gap-3 max-w-sm sm:max-w-4xl px-2 w-full">
              <div className="flex items-center justify-center gap-1.5 rounded-full bg-white/90 border border-[#1A4C98]/15 px-3 py-1.5 sm:px-3.5 text-[11px] sm:text-xs font-semibold text-[#081426] shadow-2xs backdrop-blur-sm">
              ...
              <div className="col-span-2 sm:col-span-1 flex items-center justify-center gap-1.5 rounded-full bg-white/90 border border-[#1A4C98]/15 px-3 py-1.5 sm:px-3.5 text-[11px] sm:text-xs font-semibold text-[#081426] shadow-2xs backdrop-blur-sm mx-auto sm:mx-0">
                <Store size={14} className="text-emerald-700 shrink-0" />
                <span>Store Pickup in Vellayil</span>
              </div>
            </div>
          </div>
        </div>
