          ...
          {CATEGORIES.map((cat, index) => {
            ...
            return (
              <div
                ...
                className={`group cursor-pointer rounded-2xl sm:rounded-3xl bg-[#F4F8FC] p-3 sm:p-6 border border-[#D0DFEF] hover:border-[#1A4C98]/40 hover:bg-white hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 flex flex-col justify-between ${
              ...
              >
                <div>
                  ...
                  <h3 className="text-xs sm:text-lg font-black text-[#081426] group-hover:text-[#1A4C98] transition-colors mb-0.5 sm:mb-1 leading-snug">
                    {cat.title}
                  </h3>
